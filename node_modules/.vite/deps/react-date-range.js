...
var require_roundingMethods = __commonJS({
  "node_modules/date-fns/_lib/roundingMethods.js"(exports) {
    "use strict";
...
var require_differenceInQuarters = __commonJS({
  "node_modules/date-fns/differenceInQuarters.js"(exports) {
    ...
    var _index = require_differenceInMonths();
    var _index2 = require_roundingMethods();
    function differenceInQuarters(dateLeft, dateRight, options) {
      const diff = (0, _index.differenceInMonths)(dateLeft, dateRight) / 3;
      return (0, _index2.getRoundingMethod)(options == null ? void 0 : options.roundingMethod)(diff);
    }
  }
});
...
var require_differenceInSeconds = __commonJS({
  "node_modules/date-fns/differenceInSeconds.js"(exports) {
    ...
    var _index = require_differenceInMilliseconds();
    var _index2 = require_roundingMethods();
    function differenceInSeconds(dateLeft, dateRight, options) {
      const diff = (0, _index.differenceInMilliseconds)(dateLeft, dateRight) / 1e3;
      return (0, _index2.getRoundingMethod)(options == null ? void 0 : options.roundingMethod)(diff);
    }
  }
});
...
var require_differenceInWeeks = __commonJS({
  "node_modules/date-fns/differenceInWeeks.js"(exports) {
    ...
    var _index = require_differenceInDays();
    var _index2 = require_roundingMethods();
...
var require_format = __commonJS({
  "node_modules/date-fns/format.js"(exports) {
    ...
    var _index4 = require_defaultOptions();
    var _index5 = require_formatters();
    var _index6 = require_longFormatters();
    ...
    function format(date, formatStr, options) {
      ...
      const result = formatStr.match(longFormattingTokensRegExp).map(function(substring) {
        ...
        if (formatter) {
          if (!(options == null ? void 0 : options.useAdditionalWeekYearTokens) && (0, _index7.isProtectedWeekYearToken)(substring)) {
          ...
          if (!(options == null ? void 0 : options.useAdditionalDayOfYearTokens) && (0, _index7.isProtectedDayOfYearToken)(substring)) {
            (0, _index7.warnOrThrowProtectedError)(
              substring,
              formatStr,
              String(date)
...
var require_formatDistanceStrict = __commonJS({
  "node_modules/date-fns/formatDistanceStrict.js"(exports) {
    ...
    var _index6 = require_getTimezoneOffsetInMilliseconds();
    var _index7 = require_roundingMethods();
...
var require_getUnixTime = __commonJS({
  "node_modules/date-fns/getUnixTime.js"(exports) {
    ...
    var _index = require_getTime();
    function getUnixTime(date) {
      return Math.floor((0, _index.getTime)(date) / 1e3);
    }
  }
});

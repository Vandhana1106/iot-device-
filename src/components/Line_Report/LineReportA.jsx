...
const LineReportA = ({ lineNumber, fromDate, toDate }) => {
  ...
  useEffect(() => {
    if (!lineNumber) return;    const params = new URLSearchParams();
    if (fromDate) params.append('from_date', fromDate);
    if (toDate) params.append('to_date', toDate);

    fetch(`https://oceanatlantic.pinesphere.co.in/api/api/user-line-reports/${lineNumber}/?${params}`)

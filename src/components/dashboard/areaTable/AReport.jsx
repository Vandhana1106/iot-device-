...
const API_URL = "https://oceanatlantic.pinesphere.co.in/api/get_consolidated_user_AFL_logs/";
...
const AReport = () => {
  ...
  const getFilterDisplayText = (filterType) => {
    ...
    if (filterValues.length === showFilterPopup.options.length - 1) {
      return "All Selected";
    }
...
// const API_URL = "https://oceanatlantic.pinesphere.co.in/api/user-machine-logs/";
